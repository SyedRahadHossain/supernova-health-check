      ...
      <div className="row my-5 border rounded shadow">
        ...
        <div className="col-md-6">
          <div className="p-4">
            ...
            <h5>
              Supernova is committed to render the possible standard service to
            ...
            <p>
              Supernova health check is an advanced Centre for diagnostic and
              medical services. It is one of the prestigious diagnostic
              complexes which started its activities in 1983. This is the
              ...
              latest medical equipments and advanced technology to provide round
              the clock medical investigations and consultancy services. LEGAL
              STATUS Supernova is a private limited company registered with the
